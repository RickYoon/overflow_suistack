        ...
        <div className="mt-10">   
          <OverBox>
              ...
              <SubTemplateBlockVertical>                
                ...
                <Wrappertitle>
                    <Title>Stake ETH</Title>                
                    <div>Maximize your yield with LSD protocols</div>                
                </Wrappertitle>
                  ...
                  <button className="flex flex-col">
                    ...
                    <div className="flex flex-col gap-2 w-full">
                      <div className="flex justify-left gap-5 py-2">
                        ...
                        <p className="text-neutral-600 text-left">6.0 %</p>
                        <p className="text-neutral-600 text-center">TVL</p>
                        <p className="text-neutral-600 text-left">$ 14.6 B</p>
                      </div>
